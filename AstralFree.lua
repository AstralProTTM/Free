...
local Window = Library:CreateWindow({ Title = 'Astral.pro | Rewritten | BETA | V0.01', Center = true, AutoShow = true, })
...
local function UnloadNotification()
    showNotification("Notification", "Astral.pro Unloaded!", 3)
end
--------------------------------------------------------------------
...
Library:SetWatermark('Astral.pro | Rewritten | BETA | V0.01')
Library.KeybindFrame.Visible = true;
Library:OnUnload(function()
    print("Astral.pro | Rewritten | BETA | V0.01: Unloaded!")
